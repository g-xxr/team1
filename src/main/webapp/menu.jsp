    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/notice.jsp">문의사항</a></li>
            </ul>
            
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
            	<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/loginForm.jsp">로그인</a></li>
                <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/notice.jsp">회원가입</a></li>
            </ul>
            ...
            <form class="d-flex">
                <button class="btn btn-outline-dark" type="submit">
                    ...
                    장바구니
                    <span class="badge bg-dark text-white ms-1 rounded-pill">여기에 숫자 들어감</span>
                </button>
            </form>
